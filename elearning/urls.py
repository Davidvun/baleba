...
urlpatterns = [
    ...
    path('admin/users/', account_views.admin_manage_users, name='admin_manage_users'),
    path('admin/users/create-tutor/', account_views.admin_create_tutor, name='admin_create_tutor'),
    path('admin/users/<int:user_id>/edit/', account_views.admin_edit_user, name='admin_edit_user'),
    path('admin/users/<int:user_id>/delete/', account_views.admin_delete_user, name='admin_delete_user'),
    
    path('admin/courses/', course_views.admin_manage_courses, name='admin_manage_courses'),
    path('admin/courses/create/', course_views.admin_create_course, name='admin_create_course'),
    path('admin/courses/<int:course_id>/edit/', course_views.admin_edit_course, name='admin_edit_course'),
    path('admin/courses/<int:course_id>/delete/', course_views.admin_delete_course, name='admin_delete_course'),
